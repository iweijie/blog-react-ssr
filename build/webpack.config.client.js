...
const aSeparatePackage = ['codemirror', 'marked'];
  ...
  splitChunks: {
    ...
    cacheGroups: {
      vendors: {
        test: (module) => {
          let flag =
            module && module.resource && /\.js$/.test(module.resource) && module.resource.match('node_modules');
          if (!flag) return flag;
          aSeparatePackage.forEach((pageName) => {
            if (module.resource.match(pageName)) {
              flag = false;
            }
          });
          return flag;
          ...
          return {
            test: (module) => {
              return (
                ...
                module.resource.match(pageName)
              );
            },
            name: pageName,
          };
